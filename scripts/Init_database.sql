...
IF EXIST (SELECT 1 FROM sys.database WHERE name = 'SibanyeWareHouse')
BEGIN
    ALTER DATABASE SibanyeWareHouse SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE SibanyeWareHouse;
END;
GO
  
--Create the 'DataWarehouse' database
CREATE DATABASE SibanyeWareHouse;
GO

USE SibanyeWareHouse;
GO
